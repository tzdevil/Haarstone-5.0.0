...
public class HideVariableWithEnum : Editor
{
    ...
    private void SetFieldCondition()
    {
        ...
        //ShowOnEnum("cardType", "MINION", "minionAbilites"); //type1Var is only visible when type == Type1
        ShowOnEnum("cardType", "MINION", "attack"); //type1Var is only visible when type == Type1
        ShowOnEnum("cardType", "MINION", "hp"); //type1Var is only visible when type == Type1
        //ShowOnEnum("cardType", "SPELL", "spellEffect"); //type2Var is only visible when type == Type2
        ShowOnEnum("cardType", "SPELL", "castsWhenDrawn"); //type2Var is only visible when type == Type2
        ShowOnEnum("cardType", "HERO", "heroPower"); //type2Var is only visible when type == Type2
        ShowOnEnum("cardType", "HERO", "armorGiven"); //type2Var is only visible when type == Type2
        ShowOnEnum("cardType", "HERO", "portrait"); //type2Var is only visible when type == Type2
        ShowOnEnum("corruptable", "TRUE", "corruptedVersion"); //type2Var is only visible when type == Type2
